...
export const PROJECTS = [
    {
        ...
        detailsIt: {
            ...
            services: [
                ...
                { name: 'Beszel Dashboard', desc: 'Dashboard per monitorare lo stato di server e risorse interne', icon: 'gauge' },
                { name: 'Diun', desc: 'Servizio per il monitoraggio degli aggiornamenti delle immagini Docker', icon: 'update' },
                { name: 'Healthchecks', desc: 'Servizio per il monitoraggio dello stato dei backup', icon: 'backup' },
                { name: 'Homepage', desc: 'Dashboard e monitoring AIO di sistemi e servizi', icon: 'binoculars' },
                { name: 'Wallos', desc: 'Servizio per gestione e catalogazione di spese e abbonamenti', icon: 'money' },
                { name: 'YourSpotify', desc: 'Dashboard per statistiche d\'ascolto su Spotify', icon: 'stats' },
        ...
        detailsEn: {
            ...
            services: [
                ...
                { name: 'Beszel Dashboard', desc: 'Dashboard for monitoring server and internal resources', icon: 'gauge' },
                { name: 'Diun', desc: 'Service for monitoring Docker image updates', icon: 'update' },
                { name: 'Healthchecks', desc: 'Service for monitoring the status of backups', icon: 'backup' },
                { name: 'Homepage', desc: 'Dashboard and monitoring AIO of systems and services', icon: 'binoculars' },
                { name: 'Wallos', desc: 'Service for managing and cataloging expenses and subscriptions', icon: 'money' },
                { name: 'YourSpotify', desc: 'Dashboard for Spotify listening statistics', icon: 'stats' },
    ...
    },
    {
        ...
        featured: true,
        titleIt: 'Firewall OPNsense',
        titleEn: 'OPNsense Firewall',
        shortDescIt: 'Firewall e router basato su FreeBSD, con interfaccia web e funzionalità avanzate come VPN, IDS/IPS e QoS. Primo hop da WAN, gestisce il traffico in entrata e in uscita e protegge tutti i dispositivi locali, compreso il Raspberry con i suoi servizi pubblicati in internet, appoggiandosi a un sistema di protezione avanzato.',
        shortDescEn: 'Firewall and router based on FreeBSD, with a web interface and advanced features like VPN, IDS/IPS and QoS. First hop from WAN, managing incoming and outgoing traffic and protecting all local devices, including the Raspberry with its services published on the internet, relying on an advanced protection system.',
        tags: ['OPNsense', 'FreeBSD', 'Firewall', 'Router', 'VPN'],
        expandable: false,
        links: [
            { labelIt: 'Sito ufficiale', labelEn: 'Official Website', url: 'https://opnsense.org/', icon: 'external', external: true },
        ],
    },
    {
        id: 'discord-bot',
        ...
        titleIt: 'Bot Discord',
        titleEn: 'Discord Bot',
        shortDescIt: 'Bot Discord sviluppato in Node.js con discord.js e MongoDB, inizialmente sviluppato in puro javascript ma poi migrato a TypeScript, in costante sviluppo. Unico maintainer. Repository non ancora pubblica.',
        shortDescEn: 'Discord bot built with Node.js, discord.js and MongoDB, initially developed in pure JavaScript but then migrated to TypeScript, under active development. Sole maintainer. Repository not yet public.',
        tags: ['Node.js', 'discord.js', 'TypeScript', 'JavaScript', 'MongoDB', 'Beta'],
        expandable: false,
        links: [
...
export const PORTFOLIO_META = {
    lastUpdateIt: 'Settembre 2026',
    lastUpdateEn: 'September 2026',
}